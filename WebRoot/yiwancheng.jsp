...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="design.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">已完成</span></div>
        </div>
		
        <div style="width:1000px;height:500px;margin:30px">
        <%for(int i=0;i<norder && i < 100;i++){
			order=(Order)orderslist.get(i);
			%>
        	<div style="width:800px;" id="theorder<%=i%>">
            	<div id="ordertop<%=i%>" style="width:700px;height:40px;background:#9FF;">
					<span style="display:inline-block;background:#9FF;width:160px;height:40px;text-align:center;line-height:40px" id="first"><%=way%></span>
                    ...
                    <input type="hidden" name="orderid" value="<%=order.getOid()%>"></input>
                     <input type="hidden" name="state" value="<%=Data.DONE%>"></input>
				...
				<div style="position:absolute;float:left;margin-left:260px;width:0px;height:100px;border:1px solid #000;"></div>
